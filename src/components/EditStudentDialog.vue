<template>
  <div v-if="showEditDialog" class="fixed inset-0 z-50 flex items-center justify-center bg-gray-800 bg-opacity-40">
    <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-lg">
      <h4 class="text-lg font-semibold mb-4">Modifier l'étudiant</h4>
...
const showEditDialog = computed(() => props.showEditDialog)
